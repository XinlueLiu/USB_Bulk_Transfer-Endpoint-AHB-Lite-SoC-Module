...
flex_counter2 #(4)B(.clk(clk),.count_enable(clk12),.clear(1'b0),.n_rst(n_rst),.count_out(cnt_out2),.rollover_flag(bytecomplete),.rollover_value(4'b1000),.one_before_flag(bytealmostcomplete));
